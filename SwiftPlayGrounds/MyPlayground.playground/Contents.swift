...
bBirthday()
let someClo : (String) -> () = { firstItem in
    
}

let parameterBirthday: (String) -> () = { name in
    print("HB \(name)")
}


let parameterTest: (String, Int, Bool) -> () = {
    print("\($0) \($1) \($2)")
}

parameterTest("Anik", 2, true)
